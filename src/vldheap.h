...
typedef char checkDebugHeapBlockAlignment[(sizeof(crtdbgblockheader_t) % MEMORY_ALLOCATION_ALIGNMENT == 0) ? 1 : -1];
...
typedef char checkDebugUcrtHeapBlockAlignment[(sizeof(crtdbgblockheaderucrt_t) % MEMORY_ALLOCATION_ALIGNMENT == 0) ? 1 : -1];

typedef char checkDebugHeapBlockSize[(sizeof(crtdbgblockheader_t) == sizeof(crtdbgblockheaderucrt_t)) ? 1 : -1];
